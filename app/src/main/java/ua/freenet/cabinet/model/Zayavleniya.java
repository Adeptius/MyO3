...
public class Zayavleniya {
    ...
    public static List<Zayava> getAllZayava() {
        ...
        list.add(new Zayava(
                ...
                "На деякі акційні тарифи можливо перейти тільки за заявою.",
                0,
                "Залежить від умов",
                "Замовити",
                "Вкажіть дату зміни"
        ...
        list.add(new Zayava(
                ...
                "Якщо ви переїзджаєте на нову адресу, і там також підключились до нашого інтернету - ми вам перенесемо ваш рахунок на новий договір.",
                0,
                "Безкоштовно",
                "Відправити",
        ...
        list.add(new Zayava(
                "Помилкова проплата",
                MailType.WRONG_PAY,
                "Ми допоможемо вам повернути ваші кошти.",
                0,
                "Безкоштовно",
                "Відправити",
