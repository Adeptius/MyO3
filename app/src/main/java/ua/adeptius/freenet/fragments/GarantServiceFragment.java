...
import static ua.adeptius.freenet.R.id.activate_garant_button;
import static ua.adeptius.freenet.R.id.text_title;
import static ua.adeptius.freenet.R.id.text_view_for_details;
